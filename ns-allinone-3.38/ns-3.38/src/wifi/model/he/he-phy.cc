...
void
HePhy::DoResetReceive(Ptr<Eventt> event)
{
...
HePhy::ProcessSig(Ptr<Eventt> event, PhyFieldRxStatus status, WifiPpduField field)
{
...
PhyEntity::PhyFieldRxStatus
HePhy::ProcessSigA(Ptr<Eventt> event, PhyFieldRxStatus status)
{
...
PhyEntity::PhyFieldRxStatus
HePhy::ProcessSigB(Ptr<Eventt> event, PhyFieldRxStatus status)
{
    NS_LOG_FUNCTION(this << *event << status);
...
Time
HePhy::DoStartReceivePayload(Ptr<Eventt> event)
{
    NS_LOG_FUNCTION(this << *event);
...
void
HePhy::StartReceiveOfdmaPayload(Ptr<Eventt> event)
{
    NS_LOG_FUNCTION(this << event);
    Ptr<const WifiPpdu> ppdu = event->GetPpdu();
