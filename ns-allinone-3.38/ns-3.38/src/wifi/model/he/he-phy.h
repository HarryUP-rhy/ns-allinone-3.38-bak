...
class HePhy : public VhtPhy
{
  ...
  protected:
    PhyFieldRxStatus ProcessSig(Ptr<Eventt> event,
                                PhyFieldRxStatus status,
                                WifiPpduField field) override;
    Ptr<Eventt> DoGetEvent(Ptr<const WifiPpdu> ppdu, RxPowerWattPerChannelBand& rxPowersW) override;
    bool IsConfigSupported(Ptr<const WifiPpdu> ppdu) const override;
    Time DoStartReceivePayload(Ptr<Eventt> event) override;
    ...
    void DoResetReceive(Ptr<Eventt> event) override;
     ...
     */
    virtual PhyFieldRxStatus ProcessSigA(Ptr<Eventt> event, PhyFieldRxStatus status);
     ...
     */
    virtual PhyFieldRxStatus ProcessSigB(Ptr<Eventt> event, PhyFieldRxStatus status);
     ...
     */
    void StartReceiveOfdmaPayload(Ptr<Eventt> event);
