...
Eventt::Eventt(Ptr<const WifiPpdu> ppdu,
...
Ptr<const WifiPpdu>
Eventt::GetPpdu() const
{
    return m_ppdu;
}

Time
Eventt::GetStartTime() const
{
    return m_startTime;
}

Time
Eventt::GetEndTime() const
{
    return m_endTime;
}

Time
Eventt::GetDuration() const
{
    return m_endTime - m_startTime;
}

double
Eventt::GetRxPowerW() const
{
...
double
Eventt::GetRxPowerW(WifiSpectrumBand band) const
{
...
Eventt::GetRxPowerWPerBand() const
{
    return m_rxPowerW;
}

const WifiTxVector&
Eventt::GetTxVector() const
{
    return m_txVector;
}

void
Eventt::UpdateRxPowerW(const RxPowerWattPerChannelBand& rxPower)
{
...
std::ostream&
operator<<(std::ostream& os, const Eventt& event)
{
...
InterferenceHelper::NiChange::NiChange(double power, Ptr<Eventt> event)
    : m_power(power),
      m_event(event)
{
}
...
{
    Ptr<Eventt> event = Create<Eventt>(ppdu, txVector, duration, std::move(rxPowerW));
...
void
InterferenceHelper::AppendEvent(Ptr<Eventt> event, bool isStartOfdmaRxing)
{
...
void
InterferenceHelper::UpdateEvent(Ptr<Eventt> event, const RxPowerWattPerChannelBand& rxPower)
{
...
double
InterferenceHelper::CalculateNoiseInterferenceW(Ptr<Eventt> event,
...
double
InterferenceHelper::CalculatePayloadPer(Ptr<const Eventt> event,
                                        uint16_t channelWidth,
                                        NiChangesPerBand* nis,
...
double
InterferenceHelper::CalculatePhyHeaderPer(Ptr<const Eventt> event,
                                          NiChangesPerBand* nis,
                                          uint16_t channelWidth,
                                          WifiSpectrumBand band,
...
InterferenceHelper::CalculatePayloadSnrPer(Ptr<Eventt> event,
                                           uint16_t channelWidth,
                                           WifiSpectrumBand band,
                                           uint16_t staId,
...
double
InterferenceHelper::CalculateSnr(Ptr<Eventt> event,
                                 uint16_t channelWidth,
                                 uint8_t nss,
                                 WifiSpectrumBand band) const
{
...
struct PhyEntity::SnrPer
InterferenceHelper::CalculatePhyHeaderSnrPer(Ptr<Eventt> event,
                                             uint16_t channelWidth,
                                             WifiSpectrumBand band,
                                             WifiPpduField header) const
{
