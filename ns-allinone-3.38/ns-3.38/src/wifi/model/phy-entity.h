...
class PhyEntity : public SimpleRefCount<PhyEntity>
{
  public:
     ...
     */
    void StartReceiveField(WifiPpduField field, Ptr<Eventt> event);
    /**
     ...
     * \param event the event holding incoming PPDU's information
     */
    void EndReceiveField(WifiPpduField field, Ptr<Eventt> event);
     ...
     * \param event the event holding incoming PPDU's information
     */
    void EndReceivePayload(Ptr<Eventt> event);
     ...
     * \param event the event holding incoming PPDU's information
     */
    void ResetReceive(Ptr<Eventt> event);
  ...
  protected:
     ...
     */
    virtual bool DoStartReceiveField(WifiPpduField field, Ptr<Eventt> event);
    /**
     ...
     */
    virtual PhyFieldRxStatus DoEndReceiveField(WifiPpduField field, Ptr<Eventt> event);
     ...
     */
    virtual Ptr<Eventt> DoGetEvent(Ptr<const WifiPpdu> ppdu, RxPowerWattPerChannelBand& rxPowersW);
    /**
     ...
     */
    virtual PhyFieldRxStatus DoEndReceivePreamble(Ptr<Eventt> event);
    /**
     * Start the preamble detection period.
     *
     * \param event the event holding incoming PPDU's information
     */
    void StartPreambleDetectionPeriod(Ptr<Eventt> event);
    /**
     ...
     * \param event the event holding incoming PPDU's information
     */
    void EndPreambleDetectionPeriod(Ptr<Eventt> event);
     ...
     * \param event the event holding incoming PPDU's information
     */
    void StartReceivePayload(Ptr<Eventt> event);
     ...
     */
    virtual Time DoStartReceivePayload(Ptr<Eventt> event);
     ...
     * \param event the event holding incoming PPDU's information
     */
    virtual void DoResetReceive(Ptr<Eventt> event);
     ...
     * \param mpduDuration the duration of the MPDU
     */
    void EndOfMpdu(Ptr<Eventt> event,
     ...
     * \param event the event holding incoming PPDU's information
     */
    void ScheduleEndOfMpdus(Ptr<Eventt> event);
     ...
     */
    SnrPer GetPhyHeaderSnrPer(WifiPpduField field, Ptr<Eventt> event) const;
    /**
     ...
     */
    double GetRxPowerWForPpdu(Ptr<Eventt> event) const;
    /**
     ...
     */
    Ptr<const Eventt> GetCurrentEvent() const;
    /**
     ...
     */
    const std::map<std::pair<uint64_t, WifiPreamble>, Ptr<Eventt>>& GetCurrentPreambleEvents() const;
    /**
     ...
     * \param event the event holding incoming PPDU's information
     */
    void AddPreambleEvent(Ptr<Eventt> event);
     ...
     */
    Ptr<Eventt> CreateInterferenceEvent(Ptr<const WifiPpdu> ppdu,
                                       const WifiTxVector& txVector,
                                       Time duration,
     ...
     */
    void UpdateInterferenceEvent(Ptr<Eventt> event, const RxPowerWattPerChannelBand& rxPower);
    /**
