...
class VhtPhy : public HtPhy
{
  ...
  protected:
    ...
    PhyFieldRxStatus DoEndReceiveField(WifiPpduField field, Ptr<Eventt> event) override;
     ...
     */
    PhyFieldRxStatus EndReceiveSig(Ptr<Eventt> event, WifiPpduField field);
     ...
     */
    virtual PhyFieldRxStatus ProcessSig(Ptr<Eventt> event,
